...
module ReactionsExt =
    ...
    type ReactionRateModel
        ...
        member rm.getAllReactions() : list<AnyReaction> =
            ...
            | AcCatalyticSynthesisRateModel m -> m.getAllRates() |> (createReactions (fun e -> e |> AcCatalyticSynthesis))
            ...
            | AcCatalyticDestructionRateModel m -> m.getAllRates() |> (createReactions (fun e -> e |> AcCatalyticDestruction))
            ...
            | AcFwdCatalyticLigationRateModel m -> m.getAllRates() |> (createReactions (fun e -> e |> AcFwdCatalyticLigation))
            | AcBkwCatalyticLigationRateModel m -> m.getAllRates() |> (createReactions (fun e -> e |> AcBkwCatalyticLigation))
