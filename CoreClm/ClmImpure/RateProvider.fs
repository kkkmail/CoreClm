...
module RateProvider =
    ...
    type ReactionRateProvider (p: ReactionRateProviderParams, si : SubstInfo) =
        ...
        let getRatesImpl rnd t a =
            ...
            | ActivatedCatalyticSynthesis r -> tryPick ActivatedCatalyticSynthesisModel.modelGetter |> bind (fun m -> m.getRates rnd t r)
            ...
            | ActivatedCatalyticDestruction r -> tryPick ActivatedCatalyticDestructionModel.modelGetter |> bind (fun m -> m.getRates rnd t r)
            ...
            | ActivatedFwdCatalyticLigation r -> tryPick ActivatedFwdCatalyticLigationModel.modelGetter |> bind (fun m -> m.getRates rnd t r)
            | ActivatedBkwCatalyticLigation r -> tryPick ActivatedBkwCatalyticLigationModel.modelGetter |> bind (fun m -> m.getRates rnd t r)
            ...
            | ActivatedCatalyticRacemization r -> tryPick ActivatedCatalyticRacemizationModel.modelGetter |> bind (fun m -> m.getRates rnd t r)
        ...
        let tryGetModelImpl n =
            ...
            | ActivatedCatalyticSynthesisName -> tryPick ActivatedCatalyticSynthesisModel.modelGetter |> Option.bind(fun e -> ActivatedCatalyticSynthesisRateModel e |> Some)
            ...
            | ActivatedCatalyticDestructionName -> tryPick ActivatedCatalyticDestructionModel.modelGetter |> Option.bind(fun e -> ActivatedCatalyticDestructionRateModel e |> Some)
            ...
            | ActivatedFwdCatalyticLigationName -> tryPick ActivatedFwdCatalyticLigationModel.modelGetter |> Option.bind(fun e -> ActivatedFwdCatalyticLigationRateModel e |> Some)
            | ActivatedBkwCatalyticLigationName -> tryPick ActivatedBkwCatalyticLigationModel.modelGetter |> Option.bind(fun e -> ActivatedBkwCatalyticLigationRateModel e |> Some)
            ...
            | ActivatedCatalyticRacemizationName -> tryPick ActivatedCatalyticRacemizationModel.modelGetter |> Option.bind(fun e -> ActivatedCatalyticRacemizationRateModel e |> Some)
