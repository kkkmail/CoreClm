...
-- update [clm607].[dbo].[ClmTask] set [clmTaskStatusId] = 1 where [clmDefaultValueId] in (4005000022, 4005000032, 4005000021, 4005000020, 4005000014, 4005000013, 4005000005, 4005000007, 4005000044, 4005000045, 4005000058, 4005000057, 4005000063, 4005000061)
