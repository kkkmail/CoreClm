# ClmFSharp
## F# modelling of chiral symmetry breaking in chemical systems. Version 6.0.8.
...
1.	Look up the values of `ClmSys.VersionInfo.ClmBaseName` and `ClmSys.VersionInfo.MsgSvcBaseName` (e.g. `clm608`, `msg608`, `wns608`). They must match the values `from DbData\app.config`.
