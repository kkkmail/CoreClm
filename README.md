# ClmFSharp
## F# modelling of chiral symmetry breaking in chemical systems. Version 6.0.7.
...
1.	Look up the values of `ClmSys.VersionInfo.ClmBaseName` and `ClmSys.VersionInfo.MsgSvcBaseName` (e.g. `clm607`, `msg607`, `wns607`). They must match the values `from DbData\app.config`.
