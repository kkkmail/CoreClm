# ClmFSharp
## F# modelling of chiral symmetry breaking in chemical systems. Version 6.0.6.
...
1.	Look up the values of `ClmSys.VersionInfo.ClmBaseName` and `ClmSys.VersionInfo.MsgSvcBaseName` (e.g. `clm606`, `msg606`, `wns606`). They must match the values `from DbData\app.config`.
